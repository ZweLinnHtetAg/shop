        ...
        <div class="container">
          ...
          <div id="navbar" class="navbar-collapse collapse text-center">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown full-width dropdown-slide">
                ...
                <div class="dropdown-menu">
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-xs-12">
                            <a href="shop.html">
                                <img class="img-responsive" src="{{ asset('frontend/images/shop/header-img.jpg')}}" alt="menu image" />
                            </a>
                        </div>
                    </div><!-- / .row -->
                </div><!-- / .dropdown-menu -->
              ...
              <!-- Membership -->
              <li class="dropdown dropdown-slide">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="350" role="button" aria-haspopup="true" aria-expanded="false">Membership <span class="tf-ion-ios-arrow-down"></span></a>
                <ul class="dropdown-menu">
                  <li><a href="{{ asset('login') }}">Login Page</a></li>
                  <li><a href="{{ asset('register') }}">Signup Page</a></li>
                  <li><a href="forget-password.html">Forget Password</a></li>
                </ul>
              </li>
              <!-- / Membership -->
