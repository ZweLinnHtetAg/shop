<section class="main-slider">
    <div id="home_slider_wrapper" class="rev_slider_wrapper fullscreen-container" >
        <div id="home_slider" class="rev_slider fullscreenbanner tiny_bullet_slider" data-version="5.4.1">
            <ul>	<!-- SLIDE  -->
                <li data-index="rs-73" 
                data-thumb="{{ asset('frontend/images/slider/slider-1.jpg') }}"
                ...
                data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="{{ asset('frontend/images/slider/slider-1.jpg')}}" 
                ...
                <li data-index="rs-74" 
                    ...
                    data-easeout="default" 
                    data-masterspeed="300"  
                    data-thumb="{{ asset('frontend/images/slider/slider-3.jpg')}}"  
                    data-rotate="0"  
                    data-saveperformance="off"  
                    data-title="Slide">
                    <!-- MAIN IMAGE -->
                ...
                <li data-index="rs-75" 
                    ...
                    data-easeout="default" 
                    data-masterspeed="300" 
                    data-thumb="{{ asset('frontend/images/slider/slider-2.jpg')}}"
                    data-rotate="0"  
                    data-saveperformance="off"  
                    data-title="Slide" 
                    data-param1="" 
                    ...
                    data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="{{ asset('frontend/images/slider/slider-2.jpg')}}"
