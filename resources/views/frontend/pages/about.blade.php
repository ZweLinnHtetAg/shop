    ...
    <div class="container">
        ...
        <div class="row mt-40">
            <div class="col-md-3 text-center">
                <img src="{{ asset('frontend/images/about/awards-logo.png')}}">
            </div>
            <div class="col-md-3 text-center">
                <img src="{{ asset('frontend/images/about/awards-logo.png')}}">
            </div>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="team-member text-center">
                    <img class="img-circle" src="{{ asset('frontend/images/team/team-1.jpg')}}">
            ...
            <div class="col-md-3">
                <div class="team-member text-center">
                    <img class="img-circle" src="{{ asset('frontend/images/team/team-2.jpg')}}">
            ...
            <div class="col-md-3">
                <div class="team-member text-center">
                    <img class="img-circle" src="{{ asset('frontend/images/team/team-3.jpg')}}">
                    <h4>John Fexit</h4>
                    <p>Shop Manager</p>
                </div>
            </div>
